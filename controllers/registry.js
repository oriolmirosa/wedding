var Item = require('../models/registrymodel').Item,
	...
	ItemTransactionSession = require('../models/registrymodel').ItemTransactionSession,
	Give = require('../models/registrymodel').Give,
...
module.exports = {
	...
	updateItem: function(req, res) {
		...
		Item.findOne({ _id: req.body.id }, function(err, item) {
			...
			console.log(item.item.en);
			console.log(item.item.ca);
